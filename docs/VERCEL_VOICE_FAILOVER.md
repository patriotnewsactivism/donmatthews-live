...
- Health: `https://donmatthews.live/health`
- Voice webhook: `POST https://donmatthews.live/voice`
- Media stream: `wss://donmatthews.live/stream`
- xAI SIP webhook: `POST https://donmatthews.live/xai/sip`
...
- `PUBLIC_BASE_URL` is `https://donmatthews.live`.
...
1. Check `https://donmatthews.live/health`.
2. In the Telnyx TeXML application currently assigned to the Don voice number, change the voice webhook to `POST https://donmatthews.live/voice`.
