    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0a0a0a]/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          <Link href="/new" className="font-black tracking-[0.18em] text-[#c9a84c]">
            DON MATTHEWS
          </Link>
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-[1.2fr_.8fr] lg:py-28">
          <div className="self-center">
            <p className="text-xs font-black tracking-[0.22em] text-[#c9a84c]">DONMATTHEWS.LIVE — FLAGSHIP</p>
        ...
        <div className="mx-auto max-w-7xl px-5 py-20">
          ...
          <div className="mt-3 flex flex-col justify-between gap-5 md:flex-row md:items-end">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-lg text-white/55">A cleaner directory of the platforms and products instead of burying every project inside one endless homepage.</p>
            </div>
          </div>
      ...
      <section id="book" className="mx-auto grid max-w-7xl gap-10 px-5 py-24 lg:grid-cols-[.8fr_1.2fr] lg:items-center">
        ...
        <div>
          ...
          <p className="mt-5 leading-8 text-white/45">
            The WordPress rebuild gives the book its own real destination: synopsis, excerpts,
            source material, timeline, release updates, and purchase links—without forcing all of it into the homepage.
          </p>
      ...
      <section id="record" className="border-y border-white/10 bg-[#101010]">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-20 lg:grid-cols-2">
          ...
          <div className="space-y-4 text-lg leading-8 text-white/60">
            <p>The permanent site will treat the public record as structured content, not a paragraph buried halfway down a landing page.</p>
            <p>Each significant event can have a date, source link, supporting documents, related case, and its own permanent URL.</p>
          </div>
        </div>
      </section>
      ...
      <section id="music" className="mx-auto grid max-w-7xl gap-10 px-5 py-20 lg:grid-cols-[1fr_.8fr] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/55">The music stays part of the flagship, but moves into its own organized catalog with releases, track stories, embeds, and links back to the evidence behind the songs.</p>
      ...
      <section id="connect" className="border-t border-white/10 bg-[linear-gradient(180deg,#101010,#0a0a0a)]">
        <div className="mx-auto max-w-5xl px-5 py-20">
          ...
          <p className="mt-4 max-w-2xl text-lg leading-8 text-white/55">This migration preview uses the existing durable CRM pipeline. The final WordPress build stores every signup directly in the WordPress database with an administrator CSV export.</p>
          <FlagshipLeadForm />
        </div>
      </section>

      <footer className="border-t border-white/10 px-5 py-8 text-center text-sm text-white/40">
        © 2026 Don Matthews. Flagship migration preview.
      </footer>
    </main>
  );
}
