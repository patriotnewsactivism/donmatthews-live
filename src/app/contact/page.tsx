...
export default function ContactPage() {
  return (
    <FlagshipPage>
      ...
      <section className="mx-auto grid max-w-6xl gap-6 px-5 py-20 md:grid-cols-2 xl:grid-cols-3">
        <div className="rounded-xl border border-white/10 bg-white/[0.025] p-8">
          <p className="text-xs font-black tracking-[0.18em] text-[#c9a84c]">CALL</p>
          <h2 className="mt-3 text-3xl font-black">Talk to Don&apos;s line</h2>
          <p className="mt-4 leading-8 text-white/55">The official Don Matthews voice line. Ask about reporting, Civil Rights Hub, American Injustice, music, and how to support the work.</p>
          <a href={DON_VOICE_TEL} className="mt-7 inline-block font-bold text-[#c9a84c]">{DON_VOICE_DISPLAY} →</a>
        </div>
        <div className="rounded-xl border border-white/10 bg-white/[0.025] p-8">
        ...
        <div className="rounded-xl border border-white/10 bg-white/[0.025] p-8 md:col-span-2 xl:col-span-1">
