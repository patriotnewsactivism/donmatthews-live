  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-[1.2fr_.8fr] lg:py-28">
          <div className="self-center">
            ...
            <h1 className="mt-5 max-w-4xl text-5xl font-black leading-[.98] sm:text-6xl lg:text-8xl">Journalism. Technology. Music. The Record.</h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/65 sm:text-xl">The central home of Don Matthews: investigative journalism, AI and software ventures, civil-rights advocacy, documentary music, and <em>American Injustice</em>.</p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/projects" className="rounded-md bg-[#c9a84c] px-6 py-3 font-bold text-black hover:bg-[#d9bb64]">Explore the Work</Link>
              <Link href="/american-injustice" className="rounded-md border border-[#c9a84c]/50 px-6 py-3 font-bold text-[#c9a84c] hover:bg-[#c9a84c]/10">American Injustice</Link>
            </div>
          </div>
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-5 py-20 lg:grid-cols-[1fr_.8fr] lg:items-center">
        <div><p className="text-xs font-black tracking-[0.2em] text-[#c9a84c]">DOCUMENTARY MUSIC</p><h2 className="mt-3 text-4xl font-black sm:text-5xl">Bad Actors</h2><p className="mt-5 max-w-2xl text-lg leading-8 text-white/55">Documentary-style releases built around evidence, conflict, accountability, and the stories behind the record.</p><Link href="/music" className="mt-7 inline-flex rounded-md bg-[#c9a84c] px-5 py-3 font-bold text-black hover:bg-[#d9bb64]">Explore Music</Link></div>
        <Image src="/images/bad-actors-cover.jpg" alt="Bad Actors album cover" width={700} height={700} className="mx-auto w-full max-w-sm rounded-xl border border-white/10 shadow-2xl shadow-black/60" />
      </section>
